...
class OfferSellForm extends Model {
    ...
    public function rules() {
        return [
                [['source_id', 'bid', 'priced_currency'],
                'required'],
                ['seller_id', 'default', 'value' => Yii::$app->user->identity->id],
    ...
    public function save() {
        ...
        $modelOfferSellForm = new Offer();
        $modelOfferSellForm->setAttributes($this->attributes);


        $modelOfferSellForm->created_at = time();
        $modelOfferSellForm->updated_at = time();

        return $modelOfferSellForm->save();
    }

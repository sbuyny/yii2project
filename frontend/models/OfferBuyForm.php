...
class OfferBuyForm extends Model {
  ...
  public $type;
    ...
    public function rules() {
        return [
                [['source_id', 'bid'],
                'required'],
                ['buyer_id', 'default', 'value' => Yii::$app->user->identity->id],
            //   [['source_id', 'buyer_id'], 'unique', 'targetClass' => 'common\models\Offer', 'targetAttribute' => ['source_id', 'buyer_id'], 'message' => 'Вы уже разместили предложение'],
    ...
    public function save() {
        ...
        $modelOfferBuyForm = new Offer();
        $modelOfferBuyForm->setAttributes($this->attributes);


        $modelOfferBuyForm->created_at = time();
        $modelOfferBuyForm->updated_at = time();

        return $modelOfferBuyForm->save();
    }
